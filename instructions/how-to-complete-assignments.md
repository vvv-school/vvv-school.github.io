...
>1. Make sure that the [**Robot Testing Framework**](https://robotology.github.io/robot-testing-framework/index.html) is installed on your system. If you're using the system we preparared for you, it is already installed :computer: :package:
