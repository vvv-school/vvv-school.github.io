...
1. Check out the course gradebook to see whether you've really made the grade :triumph: :clap:
1. [only **assignments**] [**Duplicate** the repository](https://help.github.com/articles/duplicating-a-repository/#mirroring-a-repository) within your GitHub account to retain forever the outcome of your hard work :muscle: This way, we can make sure that deleting the assignment from the _GitHub Education_ dashboard won't cause any harm to your precious :gems:
