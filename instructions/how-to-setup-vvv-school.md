...
- Make sure that [**curl**](https://curl.haxx.se), [**jq**](https://stedolan.github.io/jq) and [**octokit**](https://github.com/octokit/octokit.rb) are installed. We use **jq** to parse [GitHub API](https://developer.github.com/v3) responses and the **octokit** ruby gem to [**trasverse** GitHub pagination](https://developer.github.com/guides/traversing-with-pagination/#consuming-the-information).
