...
- Use [GitHub Records Archiver](https://github.com/benbalter/github-records-archiver) to back up the students repositories of **vvv{yy}-{course}** organization. Then, make a zip of the output directory and protect it with a password (use the same password of [**@vvv-school-bot**](https://github.com/vvv-school-bot)). Consider splitting the zip in several archives, given that GitHub has [limitations for large files](https://help.github.com/articles/working-with-large-files/#conditions-for-large-files). Finally, upload the resulting bunch of archives to **vvv{yy}-{course}/vvv{yy}-{course}.github.io**
