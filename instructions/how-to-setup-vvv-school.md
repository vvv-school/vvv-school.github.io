...
- Upload the resulting bunch of archives to **vvv{yy}-{course}/vvv{yy}-{course}.github.io** and insert the following note in the README.md file: `As VVV{YY} is now over, the students repositories have been archived.`
