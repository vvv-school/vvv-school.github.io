...
- Upload the resulting bunch of archives to **vvv{yy}-{course}/vvv{yy}-{course}.github.io** into the **archives** directory and insert the following note in the _README.md_: `As VVV{YY} is now over, the students repositories have been archived.`
